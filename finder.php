		...
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-sm-8">
				  ...
				  <div class="post">
						<div class="slider">
							<div class="content"><h3><img src="resources/img/max.png" width="50" heigth="50">EloCloud Finder:</h3></div><center>
...
<?php
	...
	function get_elo($sum,$country_code,$api_key){
		$sum = str_replace(" ", "+",$sum);
        $url = 'https://'. $country_code . '.api.riotgames.com/lol/summoner/v3/summoners/by-name/'. $sum .'?api_key='.$api_key;
    ...
    function info_summoner_name($sum , $country_code , $api_key){
        ...
        echo "<br>Level:<b>" . $json->{'summonerLevel'} . "</b>";
        echo "<br>ID:<b>" . $json->{'id'} . "</b>";
        echo "<br>ID_CONTA:<b>" . $json->{'accountId'} . "</b>";
        echo "<br>ID_ICONE:<b>" . $json->{'profileIconId'} . "</b>";
        echo "<br>Revision Date:<b>" . $json->{'revisionDate'} . "</b><br>";
        $show_now = file_get_contents('https://'.$country_code.'.api.riotgames.com/lol/champion-mastery/v3/scores/by-summoner/'.$sum_id.'?api_key='.$api_key);
        echo "Mastery Points:<b>" . $show_now . "</b><br><br></fieldset><br>";
		echo "<br>Ranqueada Solo Duo - " . $elo ." " . $division;
		echo "<br>Ranqueada Flexivel 5x5 - " . $elo_f ." " .$division_f;
		echo "<br>Ranqueada Flexivel 3x3 - " . $elo_t ." " .$division_t;
    ...
    function get_summoner_tier($sum,$country_code,$api_key){
        ...
        $url_status = "https://". $country_code. ".api.riotgames.com/lol/league/v3/positions/by-summoner/". $sum_id ."?api_key=" . $api_key;
...
*/function info_ranked($sum_id,$country_code,$api_key){
        ...
        if (isset($json2[0])){
            ...
            echo $qnow . "</b></h3>";
            echo "<br>Ranked League:<b>" . $json2[0]->{'leagueName'} . "</b>";
            echo "<br>Ranked Tier:<b>" . $json2[0]->{'tier'} . "</b>";
            echo "<br>DIVISION:<b>" . $json2[0]->{'rank'} . "</b>";
            echo "<br>PDL'S:<b>" . $json2[0]->{'leaguePoints'} . "</b>";
        ...
        if (isset($json2[1])) {
            ...
            echo "Ranked League:<b>" . $json2[1]->{'leagueName'} . "</b>";
            echo "<br>Ranked Tier:<b>" . $json2[1]->{'tier'} . "</b>";
            echo "<br>DIVISION:<b>" . $json2[1]->{'rank'} . "</b>";
            echo "<br>PDL'S:<b>" . $json2[1]->{'leaguePoints'} . "</b>";
        ...
        if (isset($json2[2])) {
            ...
            $qnow = str_replace("TT", "3x3", $qnow);
            echo "<br><h3><b>" . $qnow . "</b></h3>";
            echo "Ranked League:<b>" . $json2[2]->{'leagueName'} . "</b>";
            echo "<br>Ranked Tier:<b>" . $json2[2]->{'tier'} . "</b>";
            echo "<br>DIVISION:<b>" . $json2[2]->{'rank'} . "</b>";
            echo "<br>PDL'S:<b>" . $json2[2]->{'leaguePoints'} . "</b>";
...
?>
	            ...
	            <div class="col-md-3 col-sm-4">
					<aside>
					  ...
					  <?php
						...
						if(isset($_POST['sum'])){
							$sum = $_POST['sum'];
							$lvl = get_lvl($sum,"br1",$api_key);
							echo "<h4><b>".$sum."</b></h4><br>";
							$icon = get_icon($sum,"br1",$api_key);
					    ...
					    function servers_status($country_code,$api_key){
							...
							echo "<fieldset>";
							echo "<h3>LOJA:</h3><b>" . $store_status . "</b><br>";
							echo "<h3>SITE: </h3><b>" . $web_status . "</b><br>";
							echo "<h3>JOGO: </h3><b>" . $client_status . "</b><br>";
							echo "<br></fieldset>";
    }
					  ?>
					  </h6>
	...
	<footer>
		<div class="container">
			...
			<p>EloCloud 2017 Todos Os Direitos Reservados</p>
		</div>
	</footer>
